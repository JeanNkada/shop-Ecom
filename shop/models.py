...
class Produit(models.Model):
    ...
    #presentation des images suivant l'ordre d'ajout
    class Meta:
        ordering = ['-date_ajout']
    ...
    # gestion des images absent dans notre bd
    @property
    def imageUrl(self):
        try:
            url = self.image.url
...
class Commande(models.Model):   
    ...
    def get_panier_total(self):
        articlecommande = self.commandearticle_set.all() # connaitre tous les articles dans le panier
